...
$Themes = @(
    ...
    @{ Name="bettercrt"; Shader="bettercrt.glsl"; Blackhole=$false; FxFirst=$true },
    @{ Name="game-crt"; Shader="in-game-crt.glsl"; Blackhole=$false; FxFirst=$true },
    @{ Name="crt"; Shader="crt.glsl"; Blackhole=$false; FxFirst=$true },
    @{ Name="rgbsplit"; Shader="glow-rgbsplit-twitchy.glsl"; Blackhole=$false; FxFirst=$false },
    @{ Name="tft"; Shader="tft.glsl"; Blackhole=$false; FxFirst=$false },
    @{ Name="dither"; Shader="dither.glsl"; Blackhole=$false; FxFirst=$false },
    @{ Name="noir"; Shader="noir-grain.glsl"; Blackhole=$false; FxFirst=$false },
